      ...
      <Stack spacing={3}>
        ...
        >
          <Stack direction={matchDownSM ? 'column' : 'row'} alignItems="center" spacing={1}>
            <Select id="genFilter" value="Gender" placeholder="Filter By">
              <MenuItem value="Gender">Gender</MenuItem>
              <MenuItem value="Male">Male</MenuItem>
              <MenuItem value="Female">Female</MenuItem>
            </Select>
            <Select id="langFilter" value="Language" placeholder="Filter By">
              <MenuItem value="Language">Language</MenuItem>
              <MenuItem value="English">English</MenuItem>
              <MenuItem value="Arabic">Arabic</MenuItem>
            </Select>
            <Select id="isActive" value="isActive" placeholder="Filter By">
  ...
  return (
    <MainCard content={false}>
      ...
      <Dialog maxWidth="sm" fullWidth onClose={handleAdd} open={add} sx={{ '& .MuiDialog-paper': { p: 0 } }}>
        {add && <AddUser user={user} onCancel={handleAdd} title="Customer" />}
      </Dialog>
    </MainCard>
  );
};
